    ...
    return (
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
            <div className="mx-auto max-w-screen-xl">
                <div className="block xl:flex xl:justify-around">
                    <div className="pb-6 xl:mb-6 md:mb-0 xl:px-20">
                        <a href="https://" className="flex items-center">
                            <img src={Logo} className="w-20 rounded h-20 mr-3 object-cover" alt="Logo" />
                            <span className="self-center md:text-base text-xs font-semibold whitespace-nowrap text-white">RWANDA CHARISMATIQUE</span>
                        </a>
                    </div>
